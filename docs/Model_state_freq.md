...
Where $frequency$ was inverse-normalised within each combination off assay and state, and $date$, $time$, $quadrant$, and $tank side$ were included as covariates.
